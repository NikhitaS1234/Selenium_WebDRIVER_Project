...
public class SignUpPage {
	...
	public void SingupPersonalDetails(String fname, String lname, String mail, String phone, String pwd, String msg) {
		...
		NextButton.click();
		/*
		 * String ActMsg1 = Success1.getText(); System.out.println("Nxt"+ ActMsg1);
		 * Assert.assertEquals(msg, ActMsg1);
		 */

	}

	public void SignupAddress(String add1, String add2, String city, String pcode, String state, String ctry,
			String msg) {
	...
	public void ValidateSucess(String msg) {
		// ((JavascriptExecutor)
		// driver).executeScript("arguments[0].scrollIntoView(true);", Cbutton);
